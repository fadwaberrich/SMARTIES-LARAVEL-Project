        ...
        <ul class="nav flex-column">
            ...
            <main class="main-content-wrapper">
                <section class="container">
                     ...
                     <h3> category list </h3>
                     <a href="{{ route('formCategory') }}" class="btn btn-primary">Create Category</a>
                    </div>
                     <table border="1">
                           ...
                           <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('formEditCategory',['category'=>$category])}}" style="margin-right: 8px;" >
                                        <i style=" color:green; font-size:25px;" class ="bi bi-pencil-square"></i>
                                    </a>
                                    <!-- Bouton "Delete" avec une icône -->
                                    <form method="POST" action="{{route('DeleteCategory',['category'=>$category])}}">
                                        @csrf
                                        @method('DELETE')
                                    
                                        <button class="bi bi-trash" style="color:red ;font-size:15px; vertical-align: middle;"></button>
