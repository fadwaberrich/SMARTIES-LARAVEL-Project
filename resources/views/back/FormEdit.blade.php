        ...
        <ul class="nav flex-column">
            ...
            <main class="main-content-wrapper">
                <section class="container">
                    ...
                    <h2>Edit Category</h2>
                    <form method="post" action="{{route('EditCategory',['category'=>$category])}}" >
                        @csrf
                        @method('put')
                        <label for="name">Name:</label>
                        <input type="text" id="nomCategorie" name="name"  value="{{$category->name}}"><br><br>
                
                        <label for="description">Description:</label><br>
                        <textarea id="description" name="description" rows="4" cols="50" value="{{$category->description}}"></textarea><br><br>
