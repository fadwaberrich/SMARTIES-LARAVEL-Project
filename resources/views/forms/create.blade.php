      ...
      <div class="container">
        <div class="row w-100 align-items-center gx-lg-2 gx-0">
          <div class="col-xxl-2 col-lg-3">
            ...
            <img src="https://static-00.iconduck.com/assets.00/barter-icon-512x133-qgmlsfxt.png"  class="img-fluid "  style="height:30px;" class="avatar avatar-sm me-3">

            </a>
            <div class="d-flex justify-content-between w-100 d-lg-none">
              <a class="navbar-brand" href="index.html">
              <img src="https://static-00.iconduck.com/assets.00/barter-icon-512x133-qgmlsfxt.png" style="height:30px;"  alt="eCommerce HTML Template">
      ...
      <div class="offcanvas offcanvas-start p-4 p-lg-0" id="navbar-default">
        ...
        <div class="d-none d-lg-block">
          <ul class="navbar-nav align-items-center ">
            ...
            <a class="nav-link" href="{{ route('forms.create') }}" id="navbarDropdownDocs" role="button" aria-haspopup="true" aria-expanded="false">
             Proposition Form
            </a>
            </li>
          </ul>
