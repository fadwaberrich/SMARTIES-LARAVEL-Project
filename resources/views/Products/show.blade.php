    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 text-center">
                <img src="{{ asset('storage/' . $product->annonce->photo) }}" class="card-img-top" alt="Image">
                <p class="mt-2 fw-bold fs-5">{{$product->annonce->titre}}</p>
            </div>
            <div class="col-md-6 text-center">
                ...
                <div class="ps-lg-10 mt-6 mt-md-0">
                    ...
                    <div class="mb-4">
                        ...
                        <!-- rating --> <small class="text-warning"> <i class="bi bi-star-fill"></i>
                            ...
                            <i class="bi bi-star-fill"></i>
                            <i class="bi bi-star-fill"></i>
                            <i class="bi bi-star-half"></i></small><a href="#" class="ms-2">{{ $totalRatings }}
                            Reviews</a>
                    </div>
                    <div class="fs-4">
                    ...
                    <div class="mb-5"><button type="button"
                        ...
                        <div class="mt-3 row justify-content-start g-2 align-items-center">
                            ...
                            <div class="col-xxl-4 col-lg-4 col-md-5 col-5 d-grid">
                                <!-- button -->
                                <a href="{{ route('barterRequests.create') }}?product_id={{ $product->id }}&annonce_id={{ $product->annonce->id }}"
                        ...
                        <div>
                            ...
                            <table class="table table-borderless mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Category:</td>
                                        <td>{{ $product->annonce->category->name }}</td>
                                ...
                                <div class="my-8">
                                    ...
                                    <form method="POST" action="{{ route('review-ratings.store') }}">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="submit" class="btn btn-primary" style="background-color: #ffc107; border-color: #ffc107;">Submit Review Rating</button>
                                        </div>
                                                ...
                                                @if ($product->reviews->count() > 0)
                                                    @foreach ($product->reviews as $review)
                                                        <div class="d-flex border-bottom pb-6 mb-6">
                                                            <!-- img -->
                                                            <!-- img --><img src="../assets/images/avatar/avatar-10.jpg"
                                                            ...
                                                            <div class="ms-5">
                                                                ...
                                                                <!-- content -->
                                                                <p class="small"> <span
                                                                        class="text-muted">{{ $review->star_rating }}</span>
                                                                    <!-- rating -->
                                                                <div class=" mb-2">
